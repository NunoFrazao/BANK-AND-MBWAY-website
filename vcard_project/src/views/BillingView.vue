                ...
                <div class="row">
                    <div class="card">
                        ...
                        <div class="col-md-12 pt-4 mb-4">
                            <div class="row pt-2">
                                <div class="col-md-6 text-center d-flex justify-content-center align-items-center pt-2">
                                    <h5>Deposit money</h5>
                                </div>
                                <div class="col-md-6 text-center d-flex justify-content-center align-items-center pt-2">
                                    <div
                                        class="card-body pt-0 p-3 text-center d-flex justify-content-center align-items-center pt-2">
                                        <RouterLink to="/deposit" class="w-100">
                                            <a class="btn bg-gradient-dark w-75 p-0 m-0">
                        ...
                        <div class="col-md-12 pb-4 mt-4">
                            <div class="row pb-2">
                                ...
                                <div class="col-md-6">
                                    <div
                                        class="card-body pt-0 p-3 text-center d-flex justify-content-center align-items-center pt-2">
                                        <RouterLink to="/my-contacts" class="w-100">
                                            <a class="btn bg-gradient-dark w-75 p-0 m-0">
                                                <i class="material-icons text-secondary">+</i>
                                            </a>
                                        </RouterLink>
...
export default {
    setup() {
        ...
        const fetchTransactions = async () => {
            const response = await axios.get(`${config.baseAPI}/transactions`)
